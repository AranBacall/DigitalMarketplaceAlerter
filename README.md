...
$ ls -sh target/DigitalMarketplaceAlerter-1.0.3.jar
23M target/DigitalMarketplaceAlerter-1.0.3.jar
$
```
...
```
$ java -jar target/DigitalMarketplaceAlerter-1.0.3.jar db migrate config/local.yml --dry-run
<snip>
...
```
$ java -jar target/DigitalMarketplaceAlerter-1.0.3.jar db migrate config/local.yml
<snip>
...
```
$ java -jar target/DigitalMarketplaceAlerter-1.0.3.jar setuserpassword -u admin -p new_password_here config/local.yml
...
```
$ java -jar target/DigitalMarketplaceAlerter-1.0.3.jar server config/local.yml
<snip>
