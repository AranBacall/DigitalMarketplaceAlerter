...
$ ls -sh target/DigitalMarketplaceAlerter-1.0.10.jar
23M target/DigitalMarketplaceAlerter-1.0.10.jar
$
```
...
```
$ java -jar target/DigitalMarketplaceAlerter-1.0.10.jar db migrate config/local.yml --dry-run
<snip>
...
```
$ java -jar target/DigitalMarketplaceAlerter-1.0.10.jar db migrate config/local.yml
<snip>
...
```
$ java -jar target/DigitalMarketplaceAlerter-1.0.10.jar setuserpassword -u admin -p new_password_here config/local.yml
...
```
$ java -jar target/DigitalMarketplaceAlerter-1.0.10.jar createnewuser -u username -p password config/local.yml
...
```
$ java -jar target/DigitalMarketplaceAlerter-1.0.10.jar server config/local.yml
<snip>
